...
<p align="center">Romanian trasnlation translations for WonderCMS (by Robert Isoski)</p>

<br><br>

This plugin adds Romanian translations to the WonderCMS admin area, based on `https://github.com/StephanStanisic/zlanguage-nl_NL` (experimental version). Plugin author: Stephan Stanisic.
